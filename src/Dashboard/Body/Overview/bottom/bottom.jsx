...
const Bottom=()=>{
    ...
    return (
        <div className={style.bottom}>
            <div className={`${style.rank_card} ${style.card} card_hover`}>
            ...
            <div className={`${style.sales_card} ${style.card} card_hover`}>
            ...
            <div className={`${style.rate_card} ${style.card} card_hover`}>
